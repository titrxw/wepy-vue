...
<block>
  <block  wx:if="{{status == 'more'}}">
    <view @tap="loadMore" class="zan-loadmore zan-loadmore--nomore">
  ...
  <block   wx:elif="{{status == 'nodata'}}">
    <view @tap="loadMore" class="zan-loadmore zan-loadmore--nodata">
      <view class="zan-loadmore__tips">{{ nodata_str }}</view>
    </view>
  </block>

  <block  wx:elif="{{status == 'loading'}}">
    <view @tap="loadMore"  class="zan-loadmore">
