<template>
  <PopView :show.sync="display" direction="bottom">
  <!--弹出窗口-->
  <view class="wrap">
...
<script>
  ...
  import Buy from './bottom_buy_bar'
